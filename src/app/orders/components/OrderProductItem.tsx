...
const OrderProductItem = ({ orderProduct }: OrderProductItemProps) => {
  ...
  return (
    <div className="flex items-center gap-4">
      <div className="flex h-[77px] w-[110px] items-center justify-center rounded-lg bg-accent">
        <Image
      ...
      <div className="flex w-full flex-col gap-1">
        <div className="flex w-fit rounded-md bg-accent px-3">
          <p className="text-[10px]">
            Vendido e entregue por :{" "}
            <span className="font-bold">Tempest Store</span>
          </p>
        </div>
